...
public class LayerNames {
  public static final String SENSITIVITIES = "natura2000-area-receptor-sensitivities";
  public static final String INCLUDED_RECEPTORS = "natura2000-area-included-receptors";
  public static final String INCLUDED_RECEPTORS_INACTIVE = "natura2000-area-included-receptors-inactive";

  public static final String NATURA2000_AREA_NATURA2000_DIRECTIVE_AREAS = "natura2000-area-natura2000-directive-areas";
  public static final String NATURA2000_AREA_SELECTED_HABITAT_TYPES = "natura2000-area-selected-habitat-types";
  ...
  public static final String NATURA2000_AREA_RECEPTOR_TOTAL_OTHER_DEPOSITIONS = "natura2000-area-receptor-total-other-depositions";
  public static final String NATURA2000_AREA_RECEPTOR_TOTAL_DEPOSITIONS = "natura2000-area-receptor-total-depositions";

  public static final String GROUP_DEPOSITION = "natura2000-area-depositions";

  public static final String LOCATION_TOTAL_DEPOSITIONS = "location-natura2000-area-receptor-total-depositions";
  public static final String LOCATION_TOTAL_SECTOR_DEPOSITIONS = "location-natura2000-area-receptor-total-sector-depositions";
